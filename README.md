...
New exemplars should be added in a way that makes them discoverable and maintainable. Each exemplar should include:

- a short description of its purpose;
- intended audience or teaching context;
- required Noteable environment/kernel;
- any required data or dependencies;
- date created or last reviewed;
- named maintainer or owner where possible.

## Design principle

This repository is not a fixed archive of Summer 2026 work. It is intended to remain an evolving, maintained space for Noteable teaching examples and guidance.
